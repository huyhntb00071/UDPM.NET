...
namespace BUS_QLBanHang
{
    public static class BUS_NhanVien
    {
        ...
        public static int Insert(string email, string tenNV, string diaChi, byte vaiTro, byte tingTrang, string matKhau)
        {
            return dalNhanVien.Insert(email, tenNV, diaChi,vaiTro, tingTrang, matKhau);
        }
